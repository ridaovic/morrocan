...
<head>
    ...
    <link rel='apple-touch-icon' sizes='114x114' href='images/logo 5.png' />
    <link rel='apple-touch-icon' sizes='144x144' href='images/logo 5.png' />
    <meta name='msapplication-TileImage' content='images/logo 5.png' />
  ...
  <body>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-7">
              <ul class="kd-topinfo">
                <li>
                  <i class="fa fa-phone"></i> Phone: +212 6 38 88 22 64
                </li>
                <li>
                  <i class="fa fa-envelope-o"></i> <a href="#">Email: Info@Morrocanguide.com</a>
                </li>
              </ul>
            </div>
            <div class="col-md-5">
                  ...
                  <div class="navbar-header">
                   ...
                   <div class="collapse navbar-collapse" id="navbar-collapse-1">
                    <ul class="nav navbar-nav">
                      ...
                      <li><a href="Ville.html">Villes</a></li>  
                      <li><a href="package.html">Nos Packaes</a></li>    
      ...
      <section class="kd-pagesection" style=" padding: 0px 0px 0px 0px; background: #ffffff; ">
        <div class="container">
          <div class="row">
            ...
            <br/>
             <h5 align="center">
              Le Maroc est un pays riche est  plein de monument historique, de la verdure et de beaucoup des endroits fabuleuse mais malheureusement  la majorité des touristes qui veulent venir visiter notre pays ne savent pas comment organisé leur séjour est aussi ne savent pas les endroits qui peuvent leur apprécier ce qui leur pose beaucoup de problèmes.
              Donc la question qui se pose c’est comment en va régler ces problèmes pour que les touristes puissent passer leur séjour dans des conditions favorables ?
              </h5>
            <br/>
            <br/>
              ...
              <div class="kd-team kd-teamgrid">
                <div class="row">
                  <article class="col-md-4">
                    <figure><a href="#"><img src="extraimages/team1.jpg" alt=""></a></figure>
                    <section class="kd-teaminfo">
                      <h5><a href="#">Oumaima Elfahli</a></h5>
                      <span>Infografiste</span>
                      <div class="kd-social-network">
                        <ul>
                          <li><a href="#" data-original-title="Facebook"><i class="fa fa-facebook-square"></i></a></li>
                          <li><a href="#" data-original-title="Twitter"><i class="fa fa-twitter-square"></i></a></li>
                          <li><a href="#" data-original-title="Google"><i class="fa fa-google-plus-square"></i></a></li>
                        </ul>
                      </div>
                    </section>
                  </article>
                  <article class="col-md-4">
                    <figure><a href="#"><img src="extraimages/team2.jpg" alt=""></a></figure>
                    <section class="kd-teaminfo">
                      <h5><a href="#">Kanoun Salah-Eddine</a></h5>
                  ...
                  <article class="col-md-4">
                    <figure><a href="#"><img src="extraimages/team4.jpg" alt=""></a></figure>
                    <section class="kd-teaminfo">
                      <h5><a href="#">Rida Rhanim</a></h5>
   ...
   <footer id="footer-widget">
      <div class="container">
        <div class="row">
          ...
          <div class="widget col-md-4 kd-followus-widget">
            <div class="kd-widget-title"><h2>SUIVEZ-NOUS</h2></div>
            <ul>
          ...
          <div style="margin:0 auto; width: 227px;">
           ...
           <a href="index.html" class="logo"><img src="images/logo1.png" alt="Morrocan guid" ></a>
             </div>
          </div>
          ...
          <div class="widget col-md-4 kd-userinfo-widget">
            ...
            <ul>
                <li><i class="fa fa-phone-square"></i> +212 6 38 88 22 64</li>
                <li><i class="fa fa-envelope"></i> info@Marrocanguide.com</li>
                <li><i class="fa fa-skype"></i> <a href="#">Morrocan.guide </a></li>
              </ul>
          </div>
    ...
    <div id="copyright">
      <div class="container">
        <div class="row">
          <div class="col-md-12"><p>© Copyright 2015 All Rights Reserved by Morrocan guide</p></div>
        </div>
      </div>
    </div>
    <!--// CopyRight //-->
