    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <p><a href="users_edit.php" class="btn btn-success main-add">Add new user</a></p>
                    ...
                    <thead>
                     ...
                     <?php 
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="work_edit.php?id=" class="btn btn-default">Edit</a>
                                <a href="?delete=" class="btn btn-default" onclick="return confirm('sur de sur')">Supprimer</a>
                            </td>
                        </tr>
                                                <?php }
                                            }
